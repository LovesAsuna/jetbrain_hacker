<script lang="ts">
    ...
    function internalFilter(node: SVGSVGElement) {
        let symbols = node.getElementsByTagName("symbol");
        let length = symbols.length;
        let family: Array<string> = [];
        for (let i = 0; i < length; i++) {
            family.push(symbols[i].id)
        }
        filter(family)
    }
</script>
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
     style="position: absolute; width: 0; height: 0" aria-hidden="true" id="__SVG_SPRITE_NODE__" use:internalFilter>
    ...
    <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" id="kotlin">
        <radialGradient id="kotlin_kotlin_svg__a" cx="240.403" cy="-23.657" r="81.297"
                        gradientTransform="matrix(.8455 0 0 -.8455 -145.249 -17.54)" gradientUnits="userSpaceOnUse">
            <stop offset=".003" stop-color="#e44857"></stop>
            <stop offset=".469" stop-color="#c711e1"></stop>
            <stop offset="1" stop-color="#7f52ff"></stop>
        </radialGradient>
        <path fill="url(#kotlin_kotlin_svg__a)" d="M60 60H0V0h60L29.4 29.6z"></path>
    </symbol>
    ...
    <symbol xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48" id="codegears">
        <defs>
            <linearGradient id="codegears_codegears_svg__a" x1="30" x2="0" y1="0" y2="30"
                            gradientUnits="userSpaceOnUse">
                <stop offset=".205" stop-color="#0094FF"></stop>
                <stop offset=".804" stop-color="#3BEA62"></stop>
            </linearGradient>
            <linearGradient id="codegears_codegears_svg__b" x1="30" x2="0" y1="0" y2="30"
                            gradientUnits="userSpaceOnUse">
                <stop offset=".196" stop-color="#3BEA62"></stop>
                <stop offset=".801" stop-color="#0094FF"></stop>
            </linearGradient>
        </defs>
        <path fill="url(#codegears_codegears_svg__a)" d="M30 0v30H0l18 18h30V18L30 0Z"></path>
        <path fill="url(#codegears_codegears_svg__b)" d="M18 48V18h30L30 0H0v30l18 18Z"></path>
    </symbol>
    <symbol xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 298 64" id="jetbrains-white">
        <defs>
            <linearGradient id="jetbrains-white_jetbrains-white_svg__a" x1=".85" x2="62.62" y1="62.72" y2="1.81"
                            gradientUnits="userSpaceOnUse">
                <stop stop-color="#FF9419"></stop>
                <stop offset=".43" stop-color="#FF021D"></stop>
                <stop offset=".99" stop-color="#E600FF"></stop>
    ...
    <symbol xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="none"
            viewBox="0 0 24 24" id="arrow-icon">
        <clipPath id="arrow-icon_a">
            <path d="m0 0h24v24h-24z"></path>
        </clipPath>
        <g clip-path="url(#arrow-icon_a)">
            <path d="m16.172 11.0002-5.364-5.36403 1.414-1.414 7.778 7.77803-7.778 7.778-1.414-1.414 5.364-5.364h-12.172v-2z"
                  fill="#fff"></path>
        </g>
    </symbol>
</svg>